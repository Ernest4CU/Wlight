/**************************************************************************//**
 * @file    project_template/IP/Example/system_ht32f175x_275x.c
 ...
 */
  ...
  #define CKCU_CKST     CKCU->CKST                        /*!< Clock Source Status register                 */
  ...
  #define CKCU_CKST     (*(vu32 *)(CKCU_BASE + 0x034))    /*!< Clock Source Status register                 */
