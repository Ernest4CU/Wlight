...
#ifndef __HT32F175x_275x_GPIO_H
#define __HT32F175x_275x_GPIO_H
...
/**
  ...
  */
#define IS_GPIO(x)          ((x == GPIOA) || (x == GPIOB) || (x == GPIOC) || (x == GPIOD) || (x == GPIOE))
/**
