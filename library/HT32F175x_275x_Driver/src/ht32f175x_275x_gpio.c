...
void GPIO_DeInit(GPIO_TypeDef* GPIOx)
{
  ...
  {
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_PC, ENABLE);
  }
  else if(GPIOx == GPIOD)
  {
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_PD, ENABLE);
  }
  else
  {
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_PE, ENABLE);
  }
}
...
void AFIO_GPCConfig(u32 AFIO_PIN, u32 AFIO_MODE)
{
  ...
  AFIO->GPCCFGR = (AFIO->GPCCFGR & ~AFIO_PIN) | (AFIO_MODE & AFIO_PIN);
}
...
void AFIO_GPDConfig(u32 AFIO_PIN, u32 AFIO_MODE)
{
  ...
  AFIO->GPDCFGR = (AFIO->GPDCFGR & ~AFIO_PIN) | (AFIO_MODE & AFIO_PIN);
}
...
void AFIO_GPEConfig(u32 AFIO_PIN, u32 AFIO_MODE)
{
  ...
  AFIO->GPECFGR = (AFIO->GPECFGR & ~AFIO_PIN) | (AFIO_MODE & AFIO_PIN);
}
