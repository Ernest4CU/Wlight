/*********************************************************************************************************//**
 * @file    ht32f175x_275x_usbd.c
 * @version V1.0
 * @date    01/15/2013
 * @brief   The HT32F175x/275x USB Device Peripheral Driver.
 *************************************************************************************************************
 *
...
/**
  * @}
  */
/* End of USBDevice_Private_Constant group                                                                  */

/* Private typedef -----------------------------------------------------------------------------------------*/
/** @defgroup USBDevice_Private_TypesDefinitions USB Device private types definitions
  * @{
  */
...
/**
  * @}
  */
/* End of USBDevice_Private_TypesDefinitions group                                                          */

/* Global variables ----------------------------------------------------------------------------------------*/
/** @defgroup USBDevice_Global_Variable USB Device global variables
  * @{
  */
...
/**
  * @}
  */
/* End of USBDevice_Global_Variable group                                                                   */
...
/**
  * @}
  */
/* End of USBDevice_Private_Variable group                                                                  */
...
/**
  * @}
  */
/* End of USBDevice_Private_Macro group                                                                     */

/* Private function prototypes -----------------------------------------------------------------------------*/
/** @defgroup USBDevice_Private_Function_Prototype USB Device private function prototypes
  * @{
  */
static void _USBD_CopyMemory(u32 *pFrom, u32 *pTo, u32 len);
static USBEP_TypeDef * _USBD_GetEPTnAddr(USBD_EPTn_Enum EPTn);
/**
  * @}
  */
/* End of USBDevice_Private_Function_Prototype group                                                        */

/* Global functions ----------------------------------------------------------------------------------------*/
/** @defgroup USBDDevice_Global_Function USBD Device global functions
  * @{
  */
...
{
  RSTCU_APBPerip1Reset(RSTCU_APBRST1_USB, ENABLE);
  return;
}
...
{
  USBD_Driver_TypeDef *pDrv = (USBD_Driver_TypeDef *)pDriver;
  USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
...
{
  USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  return (USB_SRAM_BASE + (USBEPn->CFGR & EPBUFA_MASK));
}
...
{
  USBEP_TypeDef *USBEPn = _USBD_GetEPTnAddr(EPTn);
  return (USB_SRAM_BASE + (USBEPn->CFGR & EPBUFA_MASK) + USBD_EPTGetBufferLen(EPTn));
}
...
/*********************************************************************************************************//**
  ...
  * @retval Total length writen by this function
  ***********************************************************************************************************/
...
/**
  * @}
  */
/* End of USBDevice_Global_Function group                                                                   */
...
static USBEP_TypeDef * _USBD_GetEPTnAddr(USBD_EPTn_Enum EPTn)
{
  return ((USBEP_TypeDef *)(USBEP0 + EPTn));
}

/**
  * @}
  */
/* End of USBDevice_Private_Function group                                                                  */
