/*********************************************************************************************************//**
 * @file    ht32f175x_275x_ckcu.c
 * @version V1.0
 * @date    12/02/2010
 * @brief   This library provides all the Clock Control Unit functions.
 *************************************************************************************************************
 *
...
#define CKCU_MASK_PLLST         ((u32)0x000F << CKCU_POS_PLLST)
...
/*********************************************************************************************************//**
 * @brief Configures the system clock (SYS_CK).
 *        This parameter can be:
...
ErrStatus CKCU_SysClockConfig(CKCU_SW_TypeDef CLKSRC)
{
  ...
  while (--cnt)
  {
    if (((CKCU->CKST >> 30) & CKCU_MASK_SW) == CLKSRC)
      break;
  }

  return ((cnt != 0)?(SUCCESS):(ERROR));
}
...
/*********************************************************************************************************//**
 * @brief Configure the USB divider.
 * @param USBPRE: specifies the value of divider.
 *        This parameter can be:
 *        @arg CKCU_USBPRE_DIV1 : USB clock divided by 1.
 *        @arg CKCU_USBPRE_DIV2 : USB clock divided by 2.
 *        @arg CKCU_USBPRE_DIV3 : USB clock divided by 3.
 * @retval None
 ************************************************************************************************************/
void CKCU_SetUSBPrescaler(CKCU_USBPRE_TypeDef USBPRE)
{
  CKCU_BF_WRITE(CKCU->GCFGR, CKCU_MASK_USBPRE, CKCU_POS_USBPRE, USBPRE);
}
 ...
 *        This parameter can be:
 *        @arg CKCU_APBEN1_MCTM, CKCU_APBEN1_WDT,  CKCU_APBEN1_RTC,  CKCU_APBEN1_GPTM0, CKCU_APBEN1_GPTM1,
 ...
 *        This parameter can be:
 *        @arg CKCU_AHBEN_SLEEP_FMC
 *        @arg CKCU_AHBEN_SLEEP_SRAM
 ...
 * @param CKCU_CLK: specifies the clock which is enabled or disabled.
 *        This parameter can be:
 *        @arg CKCU_AHBEN_PDMA
 *        @arg CKCU_AHBEN_CSIF
 *        @arg CKCU_AHBEN_CSIFM
 * @param Cmd: new status of the specific clocks.
 *        This parameter can be:
 *        @arg ENABLE
 *        @arg DISABLE
 ...
 *             CKCU_DBG_WDT_HALT      , CKCU_DBG_MCTM_HALT
 ...
 *             CKCU_DBG_SCI_HALT      , CKCU_DBG_BFTM0_HALT
 *             CKCU_DBG_BFTM1_HALT
