...
/** @defgroup SCI_Private_TypesDefinitions SCI private types definitions
  * @{
  */
...
/** @defgroup SCI_Private_Macro SCI private macros
  * @{
  */
...
/** @defgroup SCI_Private_Variable SCI private variables
  * @{
  */
...
/** @defgroup SCI_Private_Function_Prototype Prototypes of SCI private functions
  * @{
  */
...
/** @defgroup SCI_Private_Function SCI private functions
  * @{
  */
...
{
  RSTCU_APBPerip0Reset(RSTCU_APBRST0_SCI, ENABLE);
}
...
void SCI_Init(SCI_InitTypeDef* SCI_InitStruct)
{
  ...
  SCI->PSC = SCI_InitStruct->SCI_ClockPrescale;
}
...
void SCI_Cmd(ControlStatus NewState)
{
  ...
  else
  {
    ...
    SCI->CR &= CR_ENSCI_RESET;
  }
}

/*********************************************************************************************************//**
  * @brief  This function is used to configure the Elementary Time Unit.
  * @param  SCI_ETU: sepcifies the SCI Elementary Time Unit.
...
void SCI_ETUConfig(u32 SCI_ETU, u32 SCI_Compensation)
{
  ...
  SCI->ETU = SCI_ETU | SCI_Compensation;
}

/*********************************************************************************************************//**
  * @brief  This function is used to set the value of SCI GuardTime.
  * @param  SCI_GuardTime: sepcifies the value of SCI GuardTime value.
  * @retval None
  ************************************************************************************************************/
void SCI_SetGuardTimeValue(u16 SCI_GuardTime)
{
  ...
  SCI->GT = SCI_GuardTime;
}

/*********************************************************************************************************//**
  * @brief  This function is used to set the value of SCI Waiting Time.
  * @param  SCI_WaitingTime: sepcifies the value of SCI Waiting Time value.
  * @retval None
  ************************************************************************************************************/
...
/*********************************************************************************************************//**
  * @brief  Returns the received data thorugh the SCI peripheral
...
void SCI_ClockModeConfig(u32 SCI_CLKMode)
{
  ...
  {
    SCI->CCR |= SCI_CLK_HARDWARE;
  }
  else
  {
    SCI->CCR &= SCI_CLK_SOFTWARE;
  }
}

/*********************************************************************************************************//**
  * @brief  Output the SCI clock pin low or high by software.
  * @param  SCI_CLK: pecifies if the SCI clock pin to be high or low.
  *   This parameter can be one of the following values:
...
/*********************************************************************************************************//**
  ...
  * @param  SCI_DIO: pecifies if the SCI DIO pin to be high or low.
  *   This parameter can be one of the following values:
