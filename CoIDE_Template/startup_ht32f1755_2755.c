/**
 ******************************************************************************
 * @file      startup_ht32f1755_2755
 * @author    Coocox
 * @version   V1.0
 * @date      02/25/2012
 * @brief     HT32F1255_2755 Devices Startup code.
...
void WEAK  MCTMBRK_IRQHandler(void);
void WEAK  MCTMUP_IRQHandler(void);
void WEAK  MCTMTR_IRQHandler(void);
void WEAK  MCTMCC_IRQHandler(void);
...
void (* const g_pfnVectors[])(void) =
{
  ...
  0,                          /*!< 26: Reserved                               */
  MCTMBRK_IRQHandler,         /*!< 27: Motor Timer Break                      */
  MCTMUP_IRQHandler,          /*!< 28: Motor Timer Update                     */
  MCTMTR_IRQHandler,          /*!< 29: Motor Timer Trigger                    */
  MCTMCC_IRQHandler,          /*!< 30: Motor Timer Capture/Compare            */
  0,0,0,0,                   /*!< 31-34: Reserved                             */
  GPTM0_IRQHandler,          /*!< 35: General-Purpose Timer0                  */
  GPTM1_IRQHandler,          /*!< 36: General-Purpose Timer1                  */
  0,0,0,0,                   /*!< 37-40: Reserved                             */
...
#pragma weak MCTMBRK_IRQHandler = Default_Handler
#pragma weak MCTMUP_IRQHandler = Default_Handler
#pragma weak MCTMTR_IRQHandler = Default_Handler
#pragma weak MCTMCC_IRQHandler = Default_Handler
