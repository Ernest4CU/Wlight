/*********************************************************************************************************//**
 * @file    GPIO/InputOutput/ht32f175x_275x_usbdconf.h
 * @version V1.00
 * @date    07/05/2011
...
//    <o0.0> USB Global Interrupt Enable (UGIE)
//    <o0.1> Start Of Frame Interrupt Enable (SOFIE)
//    <o0.2> USB Reset Interrupt Enable (URSTIE)
//    <o0.3> Resume Interrupt Enable (RSMIE)
//    <o0.4> Suspend Interrupt Enable (SUSPIE)
//    <o0.5> Expected Start of Frame Interrupt Enable (ESOFE)
//    <o0.8> Control Endpoint Interrupt Enable (EP0IE)
...
//      <o0.9> SETUP Data Packet Received Interrupt Enable (SDRXIE)
